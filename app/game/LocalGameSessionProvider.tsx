...
export function LocalGameSessionProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const frame = window.requestAnimationFrame(() => {
      const restoredState = { solvedPuzzleIds: loadSolvedPuzzleIds(), solveAttributions: [], timerStartedAt: null, timerStoppedAt: null };
  ...
  useEffect(() => subscribeToSolvedPuzzleIds((solvedPuzzleIds) => {
    const nextState = { solvedPuzzleIds, solveAttributions: [], timerStartedAt: null, timerStoppedAt: null };
